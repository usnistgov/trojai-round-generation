...
class PoissonNoiseXForm(ImageTransform):
    ...
    def do(self, input_obj: ImageEntity, random_state_obj: RandomState) -> ImageEntity:
        ...
        return GenericImageEntity(noisy, input_obj.get_mask(), input_obj.get_semantic_label_mask())
...
class GaussianBlurXForm(ImageTransform):
    ...
    def do(self, input_obj: ImageEntity, random_state_obj: RandomState) -> ImageEntity:
        ...
        return GenericImageEntity(blurred, input_obj.get_mask(), input_obj.get_semantic_label_mask())

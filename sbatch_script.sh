...
root_source_dataset_directory="/mnt/isgnas/home/mmajursk/trojai/source_data/nlp"

root_output_directory="/mnt/isgnas/home/mmajursk/trojai/r9/models"
...
for i in $(seq $MODELS_PER_JOB); do
  python main.py --output-filepath=${root_output_directory} --model-number="$INDEX" --source-datasets-filepath="$root_source_dataset_directory"
  INDEX=$((INDEX+1))
done

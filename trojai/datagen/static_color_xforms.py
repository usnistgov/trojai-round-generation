...
class GrayscaleToRGBXForm(Transform):
    ...
    def do(self, input_obj: ImageEntity, random_state_obj: RandomState) -> ImageEntity:
        ...
        return GenericImageEntity(rgb_img, input_obj.get_mask(), input_obj.get_semantic_label_mask())
...
class RGBtoRGBA(Transform):
    ...
    def do(self, input_obj: ImageEntity, random_state_obj: RandomState) -> ImageEntity:
        ...
        return GenericImageEntity(rgba_img, input_obj.get_mask(), input_obj.get_semantic_label_mask())

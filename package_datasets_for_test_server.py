...
def worker(ifp, root_ofp):
    ...
    for m in models:
        ...
        reduced_config['data_filepath'] = '/home/trojai/source_data/{}.json'.format(config.source_dataset)
        ...
        src = os.path.join(ifp, m, 'example_data', 'clean-example-data.json')
...
ifp = '/scratch/trojai/data/round8/round8-test-dataset/models'
root_ofp = '/scratch/trojai/data/round8/test_server/es-dataset'
worker(ifp, root_ofp)

ifp = '/scratch/trojai/data/round8/round8-holdout-dataset/models'
root_ofp = '/scratch/trojai/data/round8/test_server/holdout-dataset'
worker(ifp, root_ofp)

ifp = '/scratch/trojai/data/round8/sts'
root_ofp = '/scratch/trojai/data/round8/test_server/sts-dataset'
worker(ifp, root_ofp)

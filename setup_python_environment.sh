...
conda create -n round10 python=3.8 -y
...
conda install pandas matplotlib scipy transformers

pip install timm jsonpickle matplotlib sklearn seqeval pycocotools opencv-python imgaug imagecorruptions psutil
